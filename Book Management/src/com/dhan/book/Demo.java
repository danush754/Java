...
public class Demo {
	...
	public static void main(String[] args) {
		Book[] books = new Book[]{new Book(1,"Life Of Dhan",new Author[] {new Author(1,"Dhan","Kaai")},
				new Publisher(1,"Publisher_1"),1990,231,BigDecimal.valueOf(14.99),CoverType.PAPERBACK),
		...
		System.out.println(Arrays.toString(bookService.filterBooksByAuthor(new Author(1,"Dhan","Kaai"), books)));
		System.out.println(Arrays.toString(bookService.filterBooksAfterSpecifiedYear(2000, books)));
